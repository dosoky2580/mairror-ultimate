...
class AppProvider with ChangeNotifier {
  ...
  void setLanguage(String code) { _targetLanguage = code; notifyListeners(); }
  ...
  Future<void> _speak(String text) async {
    await _flutterTts.setLanguage(_targetLanguage == "tr" ? "tr-TR" : "en-US");
